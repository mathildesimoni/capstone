...
* authors_fields/ : *directory for take 1: find disciplines of authors and journals in MAG*
    ...
    * part3_journals_disciplines.ipynb : *sample code to link each JOURNAL in MAG with a discipline (the one with the highest score)* &nbsp
    ...
    * authors_journals_diciplines.py : *script with code of both "authors_disciplines.py" and "journals_disciplines.py"* &nbsp
    ...
    * PaperJournalSample.csv : *sample of papers and journals in MAG for part 3 notebook* &nbsp
